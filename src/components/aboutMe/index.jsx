...
const profilePic =
  "https://avatars1.githubusercontent.com/u/58235374?s=460&u=71026b20f119072d052405895f7335cc20d296a0&v=4";
...
const AboutMe = () => {
  ...
  return (
    <div className="profile">
      <div className="intro">
        <img className="profilePic" src={profilePic} alt="Marco" />
        <h1 className="headline">
          {renderHello()}!<br /> I'm{" "}
          <strong className="name">Marco Varela</strong>.
        </h1>
